...
func (x *Message) GetDsl() *DslMessage {
	if x, ok := x.GetType().(*Message_Dsl); ok {
		return x.Dsl
	}
	return nil
}
...
type Message_Dsl struct {
	Dsl *DslMessage `protobuf:"bytes,5,opt,name=dsl,proto3,oneof"`
}
...
func (*Message_Dsl) isMessage_Type() {}

// This has to be placed in the same file to avoid cyclic dependencies.
type DslMessage struct {
	...
	UserMsg   *Message `protobuf:"bytes,2,opt,name=user_msg,json=userMsg,proto3" json:"user_msg,omitempty"`
}

func (x *DslMessage) Reset() {
	*x = DslMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *DslMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DslMessage) ProtoMessage() {}

func (x *DslMessage) ProtoReflect() protoreflect.Message {
	mi := &file_messagepb_messagepb_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DslMessage.ProtoReflect.Descriptor instead.
func (*DslMessage) Descriptor() ([]byte, []int) {
	return file_messagepb_messagepb_proto_rawDescGZIP(), []int{1}
}

func (x *DslMessage) GetContextID() uint64 {
	if x != nil {
		return x.ContextID
	}
	return 0
...
func (x *DslMessage) GetUserMsg() *Message {
	if x != nil {
		return x.UserMsg
	}
	return nil
...
var file_messagepb_messagepb_proto_rawDesc = []byte{
	...
	0x70, 0x62, 0x2f, 0x6d, 0x73, 0x63, 0x70, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf8,
	...
	,
...
var file_messagepb_messagepb_proto_goTypes = []interface{}{
	...
	(*DslMessage)(nil),       // 1: messagepb.DslMessage
...
var file_messagepb_messagepb_proto_depIdxs = []int32{
	...
	3, // 1: messagepb.Message.bcb:type_name -> bcbpb.Message
	4, // 2: messagepb.Message.multisig_collector:type_name -> availabilitypb.mscpb.Message
	1, // 3: messagepb.Message.dsl:type_name -> messagepb.DslMessage
	0, // 4: messagepb.DslMessage.user_msg:type_name -> messagepb.Message
