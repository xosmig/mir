...
import (
	cbpb "github.com/filecoin-project/mir/pkg/pb/cbpb"
...
func (x *Message) GetCb() *cbpb.CBMessage {
	if x, ok := x.GetType().(*Message_Cb); ok {
		return x.Cb
	}
	return nil
}
...
type Message_Cb struct {
	Cb *cbpb.CBMessage `protobuf:"bytes,3,opt,name=cb,proto3,oneof"`
}

func (*Message_Iss) isMessage_Type() {}

func (*Message_Cb) isMessage_Type() {}
...
var file_messagepb_messagepb_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0f, 0x63, 0x62, 0x70, 0x62, 0x2f,
	0x63, 0x62, 0x70, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7c, 0x0a, 0x07, 0x4d, 0x65,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x48, 0x00, 0x52, 0x03, 0x69, 0x73, 0x73, 0x12, 0x21, 0x0a,
	0x02, 0x63, 0x62, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x63, 0x62, 0x70, 0x62,
	0x2e, 0x43, 0x42, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x48, 0x00, 0x52, 0x02, 0x63, 0x62,
