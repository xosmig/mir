...
import (
	types3 "github.com/filecoin-project/mir/codegen/generators/types-gen/types"
...
func Event_TypeFromPb(pb eventpb.Event_Type) Event_Type {
	...
	case *eventpb.Event_BatchDb:
		return &Event_BatchDb{BatchDb: pb.BatchDb}
	case *eventpb.Event_BatchFetcher:
		return &Event_BatchFetcher{BatchFetcher: pb.BatchFetcher}
...
func (w *Event_BatchDb) Pb() eventpb.Event_Type {
	return &eventpb.Event_BatchDb{BatchDb: w.BatchDb}
}
...
type Event_BatchFetcher struct {
	BatchFetcher *batchfetcherpb.Event
}
...
func (w *Event_BatchFetcher) Pb() eventpb.Event_Type {
	return &eventpb.Event_BatchFetcher{BatchFetcher: w.BatchFetcher}
}
