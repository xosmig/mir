...
func (x *Event) GetSubmodule() *SubmoduleEvent {
	if x, ok := x.GetType().(*Event_Submodule); ok {
		return x.Submodule
	}
	return nil
}
...
type Event_Submodule struct {
	Submodule *SubmoduleEvent `protobuf:"bytes,31,opt,name=submodule,proto3,oneof"`
}
...
func (*Event_Submodule) isEvent_Type() {}
...
type SubmoduleEvent struct {
	...
	SubmoduleId string `protobuf:"bytes,1,opt,name=submodule_id,json=submoduleId,proto3" json:"submodule_id,omitempty"`
	Event       *Event `protobuf:"bytes,2,opt,name=event,proto3" json:"event,omitempty"`
}

func (x *SubmoduleEvent) Reset() {
	*x = SubmoduleEvent{}
	if protoimpl.UnsafeEnabled {
...
func (x *SubmoduleEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubmoduleEvent) ProtoMessage() {}

func (x *SubmoduleEvent) ProtoReflect() protoreflect.Message {
	mi := &file_eventpb_eventpb_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubmoduleEvent.ProtoReflect.Descriptor instead.
func (*SubmoduleEvent) Descriptor() ([]byte, []int) {
	return file_eventpb_eventpb_proto_rawDescGZIP(), []int{2}
}

func (x *SubmoduleEvent) GetSubmoduleId() string {
	if x != nil {
...
func (x *SubmoduleEvent) GetEvent() *Event {
	if x != nil {
		return x.Event
	}
	return nil
...
var file_eventpb_eventpb_proto_rawDesc = []byte{
	...
	0xa2, 0x10, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x04, 0x69, 0x6e, 0x69,
	...
	0x0c, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x12, 0x37, 0x0a,
	0x09, 0x73, 0x75, 0x62, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x17, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x2e, 0x53, 0x75, 0x62, 0x6d, 0x6f,
	0x64, 0x75, 0x6c, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x48, 0x00, 0x52, 0x09, 0x73, 0x75, 0x62,
	0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x12, 0x45, 0x0a, 0x0d, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e,
	...
	0x80, 0xb5, 0x18, 0x01, 0x22, 0x06, 0x0a, 0x04, 0x49, 0x6e, 0x69, 0x74, 0x22, 0x59, 0x0a, 0x0e,
	0x53, 0x75, 0x62, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x21,
	0x0a, 0x0c, 0x73, 0x75, 0x62, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x73, 0x75, 0x62, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x49,
	...
	0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0x06, 0x0a, 0x04, 0x54, 0x69, 0x63, 0x6b, 0x22,
...
var file_eventpb_eventpb_proto_goTypes = []interface{}{
	...
	(*SubmoduleEvent)(nil),         // 2: eventpb.SubmoduleEvent
	(*Tick)(nil),                   // 3: eventpb.Tick
	(*NewRequests)(nil),            // 4: eventpb.NewRequests
...
var file_eventpb_eventpb_proto_depIdxs = []int32{
	...
	3,  // 1: eventpb.Event.tick:type_name -> eventpb.Tick
	...
	4,  // 6: eventpb.Event.new_requests:type_name -> eventpb.NewRequests
	...
	33, // 27: eventpb.Event.bcb:type_name -> bcbpb.Event
	34, // 28: eventpb.Event.mempool:type_name -> mempoolpb.Event
	35, // 29: eventpb.Event.availability:type_name -> availabilitypb.Event
	2,  // 30: eventpb.Event.submodule:type_name -> eventpb.SubmoduleEvent
	36, // 31: eventpb.Event.testingString:type_name -> google.protobuf.StringValue
	37, // 32: eventpb.Event.testingUint:type_name -> google.protobuf.UInt64Value
	0,  // 33: eventpb.Event.next:type_name -> eventpb.Event
	0,  // 34: eventpb.SubmoduleEvent.event:type_name -> eventpb.Event
	38, // 35: eventpb.NewRequests.requests:type_name -> requestpb.Request
	39, // 36: eventpb.HashRequest.data:type_name -> commonpb.HashData
	7,  // 37: eventpb.HashRequest.origin:type_name -> eventpb.HashOrigin
	7,  // 38: eventpb.HashResult.origin:type_name -> eventpb.HashOrigin
	40, // 39: eventpb.HashOrigin.context_store:type_name -> contextstorepb.Origin
	38, // 40: eventpb.HashOrigin.request:type_name -> requestpb.Request
	41, // 41: eventpb.HashOrigin.iss:type_name -> isspb.ISSHashOrigin
	42, // 42: eventpb.HashOrigin.dsl:type_name -> dslpb.Origin
	10, // 43: eventpb.SignRequest.origin:type_name -> eventpb.SignOrigin
	10, // 44: eventpb.SignResult.origin:type_name -> eventpb.SignOrigin
	40, // 45: eventpb.SignOrigin.context_store:type_name -> contextstorepb.Origin
	43, // 46: eventpb.SignOrigin.iss:type_name -> isspb.ISSSignOrigin
	42, // 47: eventpb.SignOrigin.dsl:type_name -> dslpb.Origin
	11, // 48: eventpb.VerifyNodeSigs.data:type_name -> eventpb.SigVerData
	14, // 49: eventpb.VerifyNodeSigs.origin:type_name -> eventpb.SigVerOrigin
	14, // 50: eventpb.NodeSigsVerified.origin:type_name -> eventpb.SigVerOrigin
	40, // 51: eventpb.SigVerOrigin.context_store:type_name -> contextstorepb.Origin
	44, // 52: eventpb.SigVerOrigin.iss:type_name -> isspb.ISSSigVerOrigin
	42, // 53: eventpb.SigVerOrigin.dsl:type_name -> dslpb.Origin
	38, // 54: eventpb.RequestReady.request:type_name -> requestpb.Request
	45, // 55: eventpb.SendMessage.msg:type_name -> messagepb.Message
	45, // 56: eventpb.MessageReceived.msg:type_name -> messagepb.Message
	0,  // 57: eventpb.WALAppend.event:type_name -> eventpb.Event
	0,  // 58: eventpb.WALEntry.event:type_name -> eventpb.Event
	46, // 59: eventpb.Deliver.batch:type_name -> requestpb.Batch
	38, // 60: eventpb.VerifyRequestSig.request:type_name -> requestpb.Request
	38, // 61: eventpb.RequestSigVerified.request:type_name -> requestpb.Request
	38, // 62: eventpb.StoreVerifiedRequest.request:type_name -> requestpb.Request
