...
func (x *Event) GetQuorumStorage() *quorumstoragepb.Event {
	if x, ok := x.GetType().(*Event_QuorumStorage); ok {
		return x.QuorumStorage
	}
	return nil
}
...
type Event_BatchDb struct {
	BatchDb *batchdbpb.Event `protobuf:"bytes,33,opt,name=batch_db,json=batchDb,proto3,oneof"`
}

type Event_QuorumStorage struct {
	QuorumStorage *quorumstoragepb.Event `protobuf:"bytes,34,opt,name=quorum_storage,json=quorumStorage,proto3,oneof"`
}
...
func (*Event_QuorumStorage) isEvent_Type() {}
...
var file_eventpb_eventpb_proto_rawDesc = []byte{
	...
	0x62, 0x70, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x34, 0x61, 0x76, 0x61, 0x69, 0x6c,
	0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x70, 0x62, 0x2f, 0x71, 0x75, 0x6f, 0x72, 0x75, 0x6d,
	0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x70, 0x62, 0x2f, 0x71, 0x75, 0x6f, 0x72, 0x75, 0x6d,
	0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x70, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	0x87, 0x11, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x04, 0x69, 0x6e, 0x69,
	...
	,
...
var file_eventpb_eventpb_proto_goTypes = []interface{}{
	...
	(*batchdbpb.Event)(nil),        // 37: batchdbpb.Event
	(*quorumstoragepb.Event)(nil),  // 38: quorumstoragepb.Event
	...
	(*requestpb.Batch)(nil),        // 49: requestpb.Batch
...
var file_eventpb_eventpb_proto_depIdxs = []int32{
	...
	37, // 31: eventpb.Event.batch_db:type_name -> batchdbpb.Event
	38, // 32: eventpb.Event.quorum_storage:type_name -> quorumstoragepb.Event
	...
	49, // 60: eventpb.Deliver.batch:type_name -> requestpb.Batch
