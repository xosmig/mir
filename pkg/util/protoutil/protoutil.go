...
// If VerifyOneofWrapper[W,T]() returns nil, then UnsafeUnwrapOneofWrapper[W, T] can be safely executed on an object of
// type W.
//
// Example:
...
// It is only safe to invoke if VerifyOneofWrapper[W, T]() == nil.
